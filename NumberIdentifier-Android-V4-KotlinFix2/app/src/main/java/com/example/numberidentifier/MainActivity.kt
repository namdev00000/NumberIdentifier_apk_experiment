...
class MainActivity : Activity() {
    ...
    private fun showCheckNumber() {
        ...
        val classificationContainer = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
        }
        resultBox.addView(classificationContainer, wrap())
        ...
        dialog.setOnShowListener {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                ...
                lastResult = result
                if (raw.isEmpty()) {
                    classificationContainer.removeAllViews()
                ...
                classificationContainer.removeAllViews()
                classificationContainer.addView(buildClassificationBlocks(result))
